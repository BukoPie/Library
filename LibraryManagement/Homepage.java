...
public class Homepage extends JFrame {
    ...
    public Homepage() {
        ...
        // Adds mouse listener for Return Book Dialog. - Ward.
        ReturnBook.addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                ...
                ReturnBook.setForeground(new Color(255, 200, 200));
            }

            @Override
            public void mouseExited(MouseEvent e) {
                ReturnBook.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
                ReturnBook.setForeground(Color.WHITE);
            }
        });
